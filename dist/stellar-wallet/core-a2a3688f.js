...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_stellar_wallet(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-8775d9ad-556f0cc2.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_stellar_wallet(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-76cc7c7d-0a082895.js').then(() => opts);
        }
    }
    ...
    if ((BUILD.lazyLoad || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_stellar_wallet('./shadow-css-d7d058ec-d59cb009.js').then(m => m.scopeCss(style, scopeId, false));
            }
